...
export class ClassImportController {
  ...
  async importClass(
    ...
    return await this.classesService.importClass(file, userId, {
      ...
      semesterColumn: body.semesterColumn,
      departmentColumn: body.departmentColumn,
      classCodeColumn: body.classCodeColumn,
      courseCodeColumn: body.courseCodeColumn,
      courseNameColumn: body.courseNameColumn,
      classNameColumn: body.classNameColumn,
      classExamCodeColumn: body.classExamCodeColumn,
      examDateColumn: body.examDateColumn,
      examRoomColumn: body.examRoomColumn,
      examTimeColumn: body.examTimeColumn,
      examShiftColumn: body.examShiftColumn,
      instructorColumn: body.instructorColumn,
      dobColumn: body.dobColumn,
      genderColumn: body.genderColumn,
